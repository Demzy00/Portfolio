...
const Contact = ({ isDarkMode }) => {
  ...
  return (
    <motion.div
      ...
      id="contact"
      className="w-full px-[12%] py-10 scroll-mt-20 bg bg-no-repeat bg-center bg-[url('/footer-bg-color.png')] bg-length:90%_auto dark:bg-none"
    >
      {/* // bg-[length:90%_auto] bg-[url('/footer-bg-color.png')] */}
      <motion.h4
