...
I'm a passionate full stack web developer with few years of experience in creating robust, end-to-end web solutions. I thrive on solving complex problems and seeing the bigger picture, working proficiently across both front-end ( React, JavaScript, Tailwind CSS) and back-end technologies (Node.js, PHP (Laravel), MySQL, MongoDB). 
          </p>
          <motion.ul
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
